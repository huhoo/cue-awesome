...
- **Earnings deep-dive — [`cn-earnings-note/`](cn-earnings-note/)** (v0.3.1): A-share / HK-share earnings deep-dive notes — the only financial skill delivered so far, P1-verified across 4 runs / 2 subjects. Full one-liner in the Skills table above.
